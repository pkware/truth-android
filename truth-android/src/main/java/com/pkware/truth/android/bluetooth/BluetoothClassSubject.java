 ...
 */
public class BluetoothClassSubject extends Subject {

  @Nullable
  private final BluetoothClass actual;

  public BluetoothClassSubject(@Nonnull FailureMetadata failureMetadata, @Nullable BluetoothClass actual) {
