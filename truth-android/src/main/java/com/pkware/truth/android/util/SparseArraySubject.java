 ...
 */
public class SparseArraySubject<E> extends Subject {

  @Nullable
  private final SparseArray<E> actual;

  public SparseArraySubject(@Nonnull FailureMetadata failureMetadata, @Nullable SparseArray<E> actual) {
